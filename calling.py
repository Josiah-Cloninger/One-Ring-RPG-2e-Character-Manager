...
class Callings(metaclass=MetaEnum):
    ...
    SCHOLAR = Calling(
        ...
        feature_description=("Rhymes of Lore are short verses created by many Cultures to help them remember significant facts from ancient history which might "
                             "otherwise be lost. Scholars of Middle-earth credit much of their ancient knowledge to such rhymes."),
