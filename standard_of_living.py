"""A module containing standards of living.

Classes:
    Standard_Of_Living: A class representing a standard of living.
    Standards_Of_Living: An enumeration of standards of living.
"""
...
class StandardOfLiving():
    """A class representing a standard of living.
    
    Attributes:
        level (int): The level of the standard of living.
        name (str): The name of the standard of living.
        description (str): A description of the standard of living.
        treasure_rating (int): The treasure rating required to achieve the standard of living.
    """
...
class StandardsOfLiving(metaclass=MetaEnum):
    """An enumeration of standards of living."""
    POOR = StandardOfLiving(level=0, name="Poor",
                              ...
                              treasure_rating=-30)
    FRUGAL = StandardOfLiving(level=1, name="Frugal",
                              description=("Frugal folk usually live off the produce of their own lands and pastures. They wear simple clothes at most times, "
                                           ...
                                           "they need instead."), 
                              treasure_rating=0)
    COMMON = StandardOfLiving(level=2, name="Common",
                              ...
                              treasure_rating=30)
    PROSPEROUS = StandardOfLiving(level=3, name="Prosperous",
                              description=("Almost all families belonging to a Prosperous Culture can afford to live in separate, private houses. Important "
                                           ...
                                           "beasts of burden."), 
                              treasure_rating=90)
    RICH = StandardOfLiving(level=4, name="Rich",
                              ...
                              treasure_rating=180)
    VERY_RICH = StandardOfLiving(level=5, name="Very Rich",
